...
export class LegendsComponent implements OnInit {
  public Legend;
  // declaring JSON array of legends
  /* 
  public AllLegends=[
    {
      'ID':"1",
  ...
  */
  ...
  constructor(private _route: ActivatedRoute, private router: Router,public LegendService:ArsenalService) {
    console.log('constructor has been called.')
   }

  ngOnInit() {
    console.log("ng oninit of Legends section called: ", this.Legend=this.LegendService.AllLegends)
  //let MyLegend= this._route.snapshot.paramMap.get('Description')
